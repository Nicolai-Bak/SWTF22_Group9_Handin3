...
namespace Microwave.Test.Integration
{
    ...
    public class TDStep3
    {
        ...
        public void Setup()
        {
            ...
            powerTube = new PowerTube(output,800);
            timer = new Timer();


            cooker = new CookController(timer, display, powerTube, buzzer);

            ui = new UserInterface(powerButton, timeButton, startCancelButton, door, display, light, cooker, powerTube.MaxPower);
            cooker.UI = ui;
        }
        ...
        public void CookController_Display_ShowTime_0_59_FakedTimer()
        {
            ...
            ui = new UserInterface(
                ...
                door, display, light, cooker, powerTube.MaxPower);
